...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-50 inline-flex items-center gap-0 rounded-full bg-primary p-4 text-primary-foreground shadow-lift transition-all hover:bg-primary-deep focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
    >
